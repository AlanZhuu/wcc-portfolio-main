...
const fs = require('fs');
const url = "https://en.wikipedia.org/wiki/River_Thames"; // FIRST: find a url of a page you are interested in from wikipedia 
const jsonPath = "./json/"; 
const name = "";
...
function getAllExternalLinks(soupTag){
    ...
    for(let i = 0; i < aTags.length; i++){
        ...
        if('href' in attrs){
            ...
            if(hrefValue.indexOf("index.php")==-1 && hrefValue.indexOf("#")==-1){
                if (hrefValue.indexOf("/wiki")==0){
